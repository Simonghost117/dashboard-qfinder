        ...
        <div class="">
          <section class="mx-5 py-7">
            ...
            <div class="flex gap-3 mb-5">
              ...
              <p class="text-3xl md:text-4xl font-bold">Perfil del Acuediente</p>
            </div>
            <div class="bg-white rounded-md p-6">
                <div class="flex flex-col md:flex-row justify-between items-center mb-10">
                  <p class="text-2xl md:text-3xl text-moradoOscuro font-bold">Información del acudiente de:
                ...
                <div class="grid grid-cols-12 gap-5">
                  ...
                  <div class="col-span-12 mq1185:col-span-9 mq980:col-span-10 p-6 rounded-[1.5rem] bg-white shadow-[0_0_14px_2px_#D8D2FCA3]">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                      <div class="flex-1">
                        <p class="text-moradoOscuro font-bold">CC:</p>
                        <p>1234567889</p>
                      </div>
                      <div class="flex-1">
                     ...
                     <div>
                        <p class="text-moradoOscuro font-bold">Vinculo familiar con el paciente:</p>
                        <p>Hijo</p>
                      </div>
                      <div>
                        <label class="text-moradoOscuro font-bold">Género </label>
                        <select class="w-full border-gray-200 border-2">
